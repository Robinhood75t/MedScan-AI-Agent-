    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl p-8" style={{ boxShadow: "var(--card-shadow)" }}>
          <h1 className="font-heading font-bold text-2xl text-foreground text-center mb-2">Create your account</h1>
          <p className="text-muted-foreground text-center mb-6">Start understanding your health today</p>
